...
GLOBAL_LIST_INIT_TYPED(cell_line_tables, /list, list(
	...
	CELL_LINE_TABLE_CLOWN = list(
		...
		///datum/micro_organism/cell_line/clown/glutton = 1, //ORBSTATION REMOVAL
		/datum/micro_organism/cell_line/clown/longclown = 1,
	),

	//CELL_LINE_TABLE_GLUTTON = list(/datum/micro_organism/cell_line/clown/glutton = 1), //ORBSTATION REMOVAL
