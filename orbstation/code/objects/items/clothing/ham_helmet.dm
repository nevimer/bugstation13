...
/obj/item/clothing/head/helmet/ham
	...
	icon = 'orbstation/icons/obj/items/clothing/helmet.dmi'
	worn_icon = 'orbstation/icons/obj/items/clothing/helmet.dmi'
...
/datum/dog_fashion/head/hamhelmet
	icon_file = 'orbstation/icons/obj/items/clothing/helmet.dmi'
