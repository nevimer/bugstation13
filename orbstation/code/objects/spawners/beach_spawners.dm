...
/obj/effect/spawner/random/clothing/island_time
	...
	loot = list(
		/obj/item/clothing/suit/hawaiian/green = 4,
		/obj/item/clothing/suit/hawaiian/blue = 4,
		/obj/item/clothing/suit/hawaiian/orange = 4,
		/obj/item/clothing/suit/hawaiian/purple = 4,
